...
export function AdminWorkspace() {
  ...
  return <div className="p-5 lg:p-8">
    <section className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
      ...
      <Link to="/admin/interviews" className="inline-flex h-10 items-center justify-center gap-2 rounded-xl bg-[var(--primary)] px-4 text-sm font-semibold text-white shadow-[0_7px_20px_rgba(21,20,18,.16)] transition hover:-translate-y-px hover:bg-[var(--foreground)]">管理面试 <ArrowRight className="h-4 w-4" /></Link>
    </section>
