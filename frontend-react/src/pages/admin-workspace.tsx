...
export function AdminWorkspace() {
  ...
  const metrics = useMemo<Array<[string, number, LucideIcon]>>(() => [
    ...
    ['已完成', items.filter(item => ([INTERVIEW_STATUS.COMPLETED, INTERVIEW_STATUS.REPORT_READY, INTERVIEW_STATUS.PASSED, INTERVIEW_STATUS.FAILED] as number[]).includes(item.status)).length, FileText],
  ], [items])
